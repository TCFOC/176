...
function displayData(id) {
  ...
  if (String(activ[groupIndex][0])[0] === '2') {
    ...
    const html = `
      <div style="font-size:20px">
        <strong style="color:#e91e63">ก่อนเริ่มกิจกรรม ให้น้อง ม.2 EIP ทุกกลุ่ม ตั้งแถวตามห้อง แล้วแบ่งกลุ่มตามเลขที่ไปทำกิจกรรม<br>กลุ่มที่ 1 เลขที่ 1-6, กลุ่มที่ 2 เลขที่ 7-12, กลุ่มที่ 3 เลขที่ 13-18, กลุ่มที่ 4 เลขที่ 19-24, กลุ่มที่ 5 เลขที่ 25-สุดท้าย</strong><br><br>
